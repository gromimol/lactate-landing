...
export const StopwatchIcon: React.FC<IconProps> = ({ className, size = 24 }) => (
  <svg className={className} width={size} height={size} viewBox="0 0 29 35" fill="none" xmlns="http://www.w3.org/2000/svg">
...
export const DropIcon: React.FC<IconProps> = ({ className, size = 24 }) => (
  <svg className={className} width={size} height={size} viewBox="0 0 27 34" fill="none" xmlns="http://www.w3.org/2000/svg">
...
export const BluetoothIcon: React.FC<IconProps> = ({ className, size = 24 }) => (
  <svg className={className} width={size} height={size} viewBox="0 0 18 33" fill="none" xmlns="http://www.w3.org/2000/svg">
...
export const MenuLinesIcon: React.FC<IconProps> = ({ className, size = 24 }) => (
  <svg className={className} width={size} height={size} viewBox="0 0 32 26" fill="none" xmlns="http://www.w3.org/2000/svg">
...
export const ZoneCircleIcon: React.FC<IconProps> = ({ className, size = 24 }) => (
  <svg className={className} width={size} height={size} viewBox="0 0 56 56" fill="none" xmlns="http://www.w3.org/2000/svg">
...
export const ShapeControlIcon: React.FC<IconProps> = ({ className, size = 24 }) => (
  <svg className={className} width={size} height={size} viewBox="0 0 56 51" fill="none" xmlns="http://www.w3.org/2000/svg">
...
export const StartIcon: React.FC<IconProps> = ({ className, size = 24 }) => (
  <svg className={className} width={size} height={size} viewBox="0 0 56 43" fill="none" xmlns="http://www.w3.org/2000/svg">
...
export const EnergyIcon: React.FC<IconProps> = ({ className, size = 24 }) => (
  <svg className={className} width={size} height={size} viewBox="0 0 31 51" fill="none" xmlns="http://www.w3.org/2000/svg">
...
export const ZoneIcon: React.FC<IconProps> = ({ className, size = 24 }) => (
...
export const HeartRateIcon: React.FC<IconProps> = ({ className, size = 24 }) => (
  <svg className={className} width={size} height={size} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M2 12H5L7 6L10 18L13 10L15 14L17 12H22" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
  </svg>
);

export const FlagRuIcon: React.FC<IconProps> = ({ className, size = 24 }) => (
  <svg className={className} width={size} height={size} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
export const FlagUsIcon: React.FC<IconProps> = ({ className, size = 24 }) => (
  <svg className={className} width={size} height={size} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M12 23C18.0751 23 23 18.0751 23 12C23 5.92487 18.0751 1 12 1C5.92487 1 1 5.92487 1 12C1 18.0751 5.92487 23 12 23Z" fill="#F0F0F0"/>
